...
internal class AppDbContext : AbstractContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        _ = modelBuilder.Entity<Utilisateur>().HasData(
              new Utilisateur() { Id = 1, Username = "testUser", PasswordHash = PasswordService.GetInstance().HashPassword("test123"), EntrepotDeTravailId = 1 },
              new Utilisateur() { Id = 2, Username = "Max", PasswordHash = PasswordService.GetInstance().HashPassword("test456"), EntrepotDeTravailId = 1 }
         );
