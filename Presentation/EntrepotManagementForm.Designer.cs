...
partial class EntrepotManagementForm {
    ...
    private void InitializeComponent() {
        ...
        this.QuitButton.Click += this.QuitButton_Click_1;
        // 
        // tableLayoutPanel1
        // 
        this.tableLayoutPanel1.ColumnCount = 3;
        this.tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 22.22222F));
        this.tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 55.55556F));
        this.tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 22.22222F));
        ...
        // createadresseBtn
        // 
        this.createadresseBtn.Location = new Point(10, 123);
